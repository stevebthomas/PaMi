  ...
  return (
    <div className="pixel-desktop-bg flex min-h-full flex-1 items-center justify-center p-6">
      <div className="pixel-border w-full max-w-lg bg-bg-window p-8 text-center">
        <div className="mb-2 font-pixel text-xs text-ink-soft">BAZAARLOOP</div>
        <h1 className="mb-4 font-pixel text-lg leading-relaxed text-ink">PM SIMULATOR</h1>
        ...
        <Link
          href="/sim"
          className="pixel-border inline-block bg-accent-chattr px-6 py-3 font-pixel text-xs text-white hover:-translate-y-0.5"
        >
          START DAY 1
        </Link>
